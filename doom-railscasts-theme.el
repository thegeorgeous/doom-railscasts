;;; doom-railscasts.el --- The Railscasts theme for doom-emacs  -*- lexical-binding: t; -*-

;; Copyright (C) 2020  George Thomas

;; Author: George Thomas <iamgeorgethomas@gmail.com>
;; Keywords: doom emacs railscasts
...
(def-doom-theme doom-railscasts
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-builtin-face :foreground cyan :weight 'bold)
   (font-lock-comment-delimiter-face :foreground yellow-2)
